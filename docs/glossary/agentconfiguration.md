...
to all three: the runtime binding, including its implementation release and
definition digest; the settings payload; and every revision-owned platform
declaration. See draft
