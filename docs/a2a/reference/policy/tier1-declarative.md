...
See [Runtime env](../runtime-env.md) for the full `a2a-gateway` table.
...
- [Runtime env](../runtime-env.md) — env reference
- [Tier-2 CEL](tier2-cel.md) — Tier-2 CEL bundle layout (design template)
- [Gateway roadmap](../../explanation/gateway-roadmap.md) — gateway policy roadmap
