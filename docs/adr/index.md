...
- [ADR#0057: Stream Incarnation Fencing by Subject Isolation and Sealing (Draft)](./0057-session-stream-incarnation-fencing.md)
- [ADR#0058: The Session Read Contract Is a Query Proto, Not the Projection Value (Draft)](./0058-session-query-contract-separate-from-projection.md)
