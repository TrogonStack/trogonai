...
use agent_client_protocol::schema::v1::{
    ContentBlock, ExtRequest, ForkSessionRequest, NewSessionRequest, PromptRequest, SetSessionConfigOptionRequest,
};
    ...
    tokio::task::LocalSet::new()
        .run_until(async move {
            ...
            let result = agent
                ...
                .unwrap();
            assert!(
                matches!(result.stop_reason, agent_client_protocol::schema::v1::StopReason::EndTurn),
                "expected end_turn: {:?}",
                result.stop_reason
            );
