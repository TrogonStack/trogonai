...
use agent_client_protocol::schema::v1::{
    ...
    SetSessionModeRequest, SetSessionModeResponse, StopReason, ToolCallContent, ToolCallStatus, ToolKind,
};
...
fn drain_updates(
    rx: &mut tokio::sync::mpsc::Receiver<agent_client_protocol::schema::v1::SessionNotification>,
) -> Vec<SessionUpdate> {
    let mut v = Vec::new();
