...
impl Runtime for MockRuntime {
    async fn handle_create_terminal(
        ...
        Ok(agent_client_protocol::schema::v1::CreateTerminalResponse::new(
    ...
    async fn handle_terminal_output(
        ...
        Ok(agent_client_protocol::schema::v1::TerminalOutputResponse::new(
    ...
    async fn handle_kill_terminal(
        ...
        Ok(agent_client_protocol::schema::v1::KillTerminalResponse::new())
    }
    ...
    async fn handle_release_terminal(
        ...
        Ok(agent_client_protocol::schema::v1::ReleaseTerminalResponse::new())
    }
    ...
    async fn handle_wait_for_terminal_exit(
        ...
        Ok(agent_client_protocol::schema::v1::WaitForTerminalExitResponse::new(
    ...
    async fn handle_write_text_file(
        ...
        Ok(agent_client_protocol::schema::v1::WriteTextFileResponse::new())
    }
    ...
    async fn handle_read_text_file(
        ...
        Ok(agent_client_protocol::schema::v1::ReadTextFileResponse::new(
    ...
    async fn handle_request_permission(
        ...
        Ok(agent_client_protocol::schema::v1::RequestPermissionResponse::new(
