...
async fn wasm_terminal_output_uses_mock_executor() {
    ...
    local
        .run_until(async {
            ...
            let wait_req =
                WaitForTerminalExitRequest::new(agent_client_protocol::schema::v1::SessionId::from(SESSION), terminal_id.clone());
            ...
            let output_req = agent_client_protocol::schema::v1::TerminalOutputRequest::new(
                agent_client_protocol::schema::v1::SessionId::from(SESSION),
                terminal_id,
            );
...
async fn wasm_terminal_nonzero_exit_is_captured() {
    ...
    local
        .run_until(async {
            ...
            let wait_req =
                WaitForTerminalExitRequest::new(agent_client_protocol::schema::v1::SessionId::from(SESSION), resp.terminal_id);
            let exit_resp = runtime
                .handle_wait_for_terminal_exit(wait_req)
                .await
                .expect("wait should succeed");
