    ...
    TL: TaskLimiter,
{
    ...
    async fn run_wasm_terminal(
        ...
        command: &str,
        args: &[String],
        env_vars: &[agent_client_protocol::schema::v1::EnvVariable],
        cwd: &std::path::Path,
    ...
    TL: TaskLimiter,
{
    async fn handle_create_terminal(
        &self,
        session_id: &str,
        req: agent_client_protocol::schema::v1::CreateTerminalRequest,
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::CreateTerminalResponse> {
        WasmRuntime::handle_create_terminal(self, session_id, req).await
    }

    async fn handle_terminal_output(
        &self,
        req: agent_client_protocol::schema::v1::TerminalOutputRequest,
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::TerminalOutputResponse> {
        WasmRuntime::handle_terminal_output(self, req).await
    }

    async fn handle_kill_terminal(
        &self,
        req: agent_client_protocol::schema::v1::KillTerminalRequest,
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::KillTerminalResponse> {
    ...
    async fn handle_release_terminal(
        &self,
        req: agent_client_protocol::schema::v1::ReleaseTerminalRequest,
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::ReleaseTerminalResponse> {
        WasmRuntime::handle_release_terminal(self, req).await
    }

    async fn handle_wait_for_terminal_exit(
        &self,
        req: agent_client_protocol::schema::v1::WaitForTerminalExitRequest,
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::WaitForTerminalExitResponse> {
    ...
    async fn handle_write_text_file(
        &self,
        session_id: &str,
        req: agent_client_protocol::schema::v1::WriteTextFileRequest,
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::WriteTextFileResponse> {
    ...
    async fn handle_read_text_file(
        &self,
        session_id: &str,
        req: agent_client_protocol::schema::v1::ReadTextFileRequest,
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::ReadTextFileResponse> {
    ...
    ) -> agent_client_protocol::Result<agent_client_protocol::schema::v1::RequestPermissionResponse> {
        WasmRuntime::handle_request_permission(self, req).await
    }

    fn handle_session_notification(&self, notif: agent_client_protocol::schema::v1::SessionNotification) {
...
mod tests {
    ...
    impl<N: NatsBroker + Send + Sync> WasmExecutor<N> for NeverWasmExecutor<N> {
        async fn run(
            &self,
            _: WasmRunConfig<N>,
        ) -> Result<agent_client_protocol::schema::v1::TerminalExitStatus, anyhow::Error> {
