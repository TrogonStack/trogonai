...
// source: trogon/cron/jobs/v1/job_paused.proto

#[derive(Clone, Debug, Default)]
pub struct JobPausedView<'a> {
    #[doc(hidden)]
    pub __buffa_phantom: ::core::marker::PhantomData<&'a ()>,
}
impl<'a> JobPausedView<'a> {
...
impl<'a> ::buffa::MessageView<'a> for JobPausedView<'a> {
    type Owned = super::super::JobPaused;
    ...
    fn to_owned_message(&self) -> super::super::JobPaused {
...
impl<'a> ::buffa::ViewEncode<'a> for JobPausedView<'a> {
...
impl<'__a> ::serde::Serialize for JobPausedView<'__a> {
...
impl<'a> ::buffa::MessageName for JobPausedView<'a> {
...
impl<'v> ::buffa::DefaultViewInstance for JobPausedView<'v> {
    fn default_view_instance<'a>() -> &'a Self
    where
        Self: 'a,
    {
        static VALUE: ::buffa::__private::OnceBox<JobPausedView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE
            .get_or_init(|| ::buffa::alloc::boxed::Box::new(
                <JobPausedView<'static>>::default(),
            ))
    }
}
impl ::buffa::ViewReborrow for JobPausedView<'static> {
    type Reborrowed<'b> = JobPausedView<'b>;
