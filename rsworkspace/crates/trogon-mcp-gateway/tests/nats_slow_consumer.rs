...
//!
//! Cross-references:
//! - `MCP_GATEWAY_PLAN.md` Wire-Format Pin 2 (reply inboxes), Pin 3 (queue groups)
...
mod slow_consumer {
    ...
    #[tokio::test]
    #[ignore = "scaffold; implement when slow-consumer backpressure per MCP_GATEWAY_PLAN.md Pin 2/3 lands"]
...
mod eviction {
    ...
    async fn evicted_client_new_requests_fail_closed_without_hanging() {
        ...
        unimplemented!("post-eviction requests fail fast per MCP_GATEWAY_PLAN.md Pin 2");
    }
