...
use acp_nats::{AGENT_UNAVAILABLE, AcpPrefix, AgentHandler, Bridge, Config, NatsAuth, NatsConfig};
...
use agent_client_protocol::schema::v1::{
    ...
    ExtNotification, ExtRequest, ExtResponse, ForkSessionRequest, ForkSessionResponse, Implementation,
    ...
    PromptResponse, ResumeSessionRequest, ResumeSessionResponse, SessionId, SetSessionConfigOptionRequest,
