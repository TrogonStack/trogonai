...
pub struct JobRemovedView<'a> {
    #[doc(hidden)]
    pub __buffa_phantom: ::core::marker::PhantomData<&'a ()>,
}
impl<'a> JobRemovedView<'a> {
...
impl<'a> ::buffa::MessageView<'a> for JobRemovedView<'a> {
    type Owned = super::super::JobRemoved;
    ...
    fn to_owned_message(&self) -> super::super::JobRemoved {
...
impl<'a> ::buffa::ViewEncode<'a> for JobRemovedView<'a> {
...
impl<'__a> ::serde::Serialize for JobRemovedView<'__a> {
...
impl<'a> ::buffa::MessageName for JobRemovedView<'a> {
...
impl<'v> ::buffa::DefaultViewInstance for JobRemovedView<'v> {
    fn default_view_instance<'a>() -> &'a Self
    where
        Self: 'a,
    {
        static VALUE: ::buffa::__private::OnceBox<JobRemovedView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE
            .get_or_init(|| ::buffa::alloc::boxed::Box::new(
                <JobRemovedView<'static>>::default(),
            ))
    }
}
impl ::buffa::ViewReborrow for JobRemovedView<'static> {
    type Reborrowed<'b> = JobRemovedView<'b>;
