...
impl ServiceName {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::TrogonScheduler => "trogon-scheduler",
...
mod tests {
    ...
    fn as_str_returns_expected_values() {
        ...
        assert_eq!(ServiceName::TrogonScheduler.as_str(), "trogon-scheduler");
    ...
    fn display_delegates_to_as_str() {
        ...
        assert_eq!(format!("{}", ServiceName::TrogonScheduler), "trogon-scheduler");
