...
impl<N: NatsClient> Session for TrogonSession<N> {
    ...
    fn set_model(&self, model_id: &str) -> impl std::future::Future<Output = anyhow::Result<()>> + Send + '_ {
        ...
        async move {
            ...
            *model.lock().unwrap_or_else(|e| e.into_inner()) = model_id;
            Ok(())
        }
    }
    ...
    fn load_session(
        ...
        async move {
            ...
            *model.lock().unwrap_or_else(|e| e.into_inner()) = parse_current_model_id(&v, &prefix);
            Ok(())
        }
    }
...
mod tests {
    ...
    fn usage_update_deserializes_from_nats_wire_format() {
        ...
        let notif: agent_client_protocol::schema::v1::SessionNotification =
    ...
    fn tool_call_raw_input_is_accessible() {
        ...
        let notif: agent_client_protocol::schema::v1::SessionNotification =
            serde_json::from_value(json).expect("must deserialize");
        match notif.update {
            agent_client_protocol::schema::v1::SessionUpdate::ToolCall(tc) => {
