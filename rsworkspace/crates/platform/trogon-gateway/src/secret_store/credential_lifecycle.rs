...
fn proto_source_kind(value: SourceKind) -> proto::CredentialSource {
    match value {
        ...
        SourceKind::Datadog => proto::CredentialSource::CREDENTIAL_SOURCE_DATADOG,
    }
}
...
fn proto_credential_kind(value: CredentialKind) -> proto::CredentialKind {
    match value {
        ...
        CredentialKind::WebhookToken => proto::CredentialKind::CREDENTIAL_KIND_WEBHOOK_TOKEN,
    }
}
...
fn decode_source_kind(
    ...
    match decode_known_enum(field, value)? {
        ...
        proto::CredentialSource::CREDENTIAL_SOURCE_DATADOG => Ok(SourceKind::Datadog),
...
fn decode_credential_kind(
    ...
    match decode_known_enum(field, value)? {
        ...
        proto::CredentialKind::CREDENTIAL_KIND_WEBHOOK_TOKEN => Ok(CredentialKind::WebhookToken),
...
fn proto_state_source_kind(value: SourceKind) -> proto_state::CredentialSource {
    match value {
        ...
        SourceKind::Datadog => proto_state::CredentialSource::CREDENTIAL_SOURCE_DATADOG,
    }
}
...
fn proto_state_credential_kind(value: CredentialKind) -> proto_state::CredentialKind {
    match value {
        ...
        CredentialKind::WebhookToken => proto_state::CredentialKind::CREDENTIAL_KIND_WEBHOOK_TOKEN,
    }
}
...
fn decode_source_kind_state(
    ...
    match decode_known_enum(field, value)? {
        ...
        proto_state::CredentialSource::CREDENTIAL_SOURCE_DATADOG => Ok(SourceKind::Datadog),
...
fn decode_credential_kind_state(
    ...
    match decode_known_enum(field, value)? {
        ...
        proto_state::CredentialKind::CREDENTIAL_KIND_WEBHOOK_TOKEN => Ok(CredentialKind::WebhookToken),
