...
// source: trogonai/session/sessions/v1alpha1/assistant_message_failed.proto
...
impl<'a> ::buffa::MessageName for AssistantMessageFailedView<'a> {
    ...
    const FULL_NAME: &'static str = "trogonai.session.sessions.v1alpha1.AssistantMessageFailed";
    const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.AssistantMessageFailed";
}
...
impl AssistantMessageFailedOwnedView {
    ...
    /// [`::buffa::OwnedView`].
    #[must_use]
    pub fn to_owned_message(&self) -> super::super::AssistantMessageFailed {
