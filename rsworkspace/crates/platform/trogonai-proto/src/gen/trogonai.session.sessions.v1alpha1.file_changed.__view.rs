...
impl<'a> ::buffa::MessageView<'a> for FileChangedView<'a> {
    type Owned = super::super::FileChanged;
    ...
    fn to_owned_message(
        &self,
    ) -> ::core::result::Result<super::super::FileChanged, ::buffa::DecodeError> {
    ...
    fn to_owned_from_source(
        ...
        let _ = __buffa_src;
        ::core::result::Result::Ok(super::super::FileChanged {
...
impl<'__a> ::serde::Serialize for FileChangedView<'__a> {
...
impl<'a> ::buffa::MessageName for FileChangedView<'a> {
...
::buffa::impl_default_view_instance!(FileChangedView);
::buffa::impl_view_reborrow!(FileChangedView);
/** Self-contained, `'static` owned view of a `FileChanged` message.

 Wraps [`::buffa::OwnedView`]`<`[`FileChangedView`]`<'static>>`: the decoded view and the [`::buffa::bytes::Bytes`] buffer it borrows from travel together, so the handle is `'static` and `Send + Sync` — suitable for async handlers, spawned tasks, and anywhere a `'static` bound is required.

 Field accessors return borrows tied to `&self`. Use [`Self::view`] to get the full [`FileChangedView`] when you need struct patterns, iteration helpers, or to pass the view to lifetime-parameterised code.*/
#[derive(Clone, Debug)]
pub struct FileChangedOwnedView(::buffa::OwnedView<FileChangedView<'static>>);
impl FileChangedOwnedView {
    ...
    pub fn decode(
        ...
        ::core::result::Result::Ok(
            FileChangedOwnedView(::buffa::OwnedView::decode(bytes)?),
        )
    }
    ...
    pub fn decode_with_options(
        ...
        ::core::result::Result::Ok(
            FileChangedOwnedView(::buffa::OwnedView::decode_with_options(bytes, opts)?),
        )
    }
    ...
    pub fn from_owned(
        msg: &super::super::FileChanged,
    ) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        ::core::result::Result::Ok(
            FileChangedOwnedView(::buffa::OwnedView::from_owned(msg)?),
        )
    }
    /// Borrow the full [`FileChangedView`] with its lifetime tied to `&self`.
    #[must_use]
    pub fn view(&self) -> &FileChangedView<'_> {
        self.0.reborrow()
    }
    ...
    /// [`::buffa::OwnedView`].
    #[must_use]
    pub fn to_owned_message(&self) -> super::super::FileChanged {
...
for FileChangedOwnedView {
    fn from(inner: ::buffa::OwnedView<FileChangedView<'static>>) -> Self {
        FileChangedOwnedView(inner)
    }
}
impl ::core::convert::From<FileChangedOwnedView>
for ::buffa::OwnedView<FileChangedView<'static>> {
    fn from(wrapper: FileChangedOwnedView) -> Self {
        wrapper.0
    }
}
impl ::core::convert::AsRef<::buffa::OwnedView<FileChangedView<'static>>>
for FileChangedOwnedView {
    fn as_ref(&self) -> &::buffa::OwnedView<FileChangedView<'static>> {
        &self.0
    }
}
impl ::buffa::HasMessageView for super::super::FileChanged {
    type View<'a> = FileChangedView<'a>;
    type ViewHandle = FileChangedOwnedView;
}
impl ::serde::Serialize for FileChangedOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
