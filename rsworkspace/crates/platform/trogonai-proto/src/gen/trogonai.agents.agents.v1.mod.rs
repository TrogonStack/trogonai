...
include!("trogonai.agents.agents.v1.instructions.rs");
...
pub mod __buffa {
    ...
    pub mod view {
        #[allow(unused_imports)]
        use super::*;
        include!("trogonai.agents.agents.v1.instructions.__view.rs");
    ...
    pub fn register_types(reg: &mut ::buffa::type_registry::TypeRegistry) {
        reg.register_json_any(super::__INSTRUCTIONS_JSON_ANY);
