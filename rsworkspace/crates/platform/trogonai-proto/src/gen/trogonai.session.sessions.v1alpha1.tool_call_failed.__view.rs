...
// source: trogonai/session/sessions/v1alpha1/tool_call_failed.proto

/// ToolCallFailed records that a tool call finished with an error. Per
/// tool_execution_id, this competes with ToolCallCompleted under a
...
pub struct ToolCallFailedView<'a> {
    /// Field 1: `session_id`
...
impl<'a> ::buffa::MessageView<'a> for ToolCallFailedView<'a> {
    type Owned = super::super::ToolCallFailed;
    ...
    fn to_owned_message(
        &self,
    ) -> ::core::result::Result<super::super::ToolCallFailed, ::buffa::DecodeError> {
    ...
    fn to_owned_from_source(
        ...
        let _ = __buffa_src;
        ::core::result::Result::Ok(super::super::ToolCallFailed {
...
impl<'a> ::buffa::ViewEncode<'a> for ToolCallFailedView<'a> {
...
impl<'__a> ::serde::Serialize for ToolCallFailedView<'__a> {
...
impl<'a> ::buffa::MessageName for ToolCallFailedView<'a> {
    const PACKAGE: &'static str = "trogonai.session.sessions.v1alpha1";
    const NAME: &'static str = "ToolCallFailed";
    const FULL_NAME: &'static str = "trogonai.session.sessions.v1alpha1.ToolCallFailed";
    const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.ToolCallFailed";
}
::buffa::impl_default_view_instance!(ToolCallFailedView);
::buffa::impl_view_reborrow!(ToolCallFailedView);
/** Self-contained, `'static` owned view of a `ToolCallFailed` message.

 Wraps [`::buffa::OwnedView`]`<`[`ToolCallFailedView`]`<'static>>`: the decoded view and the [`::buffa::bytes::Bytes`] buffer it borrows from travel together, so the handle is `'static` and `Send + Sync` — suitable for async handlers, spawned tasks, and anywhere a `'static` bound is required.

 Field accessors return borrows tied to `&self`. Use [`Self::view`] to get the full [`ToolCallFailedView`] when you need struct patterns, iteration helpers, or to pass the view to lifetime-parameterised code.*/
#[derive(Clone, Debug)]
pub struct ToolCallFailedOwnedView(::buffa::OwnedView<ToolCallFailedView<'static>>);
impl ToolCallFailedOwnedView {
    ...
    pub fn decode(
        ...
        ::core::result::Result::Ok(
            ToolCallFailedOwnedView(::buffa::OwnedView::decode(bytes)?),
        )
    }
    ...
    pub fn from_owned(
        msg: &super::super::ToolCallFailed,
    ) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        ::core::result::Result::Ok(
            ToolCallFailedOwnedView(::buffa::OwnedView::from_owned(msg)?),
        )
    }
    /// Borrow the full [`ToolCallFailedView`] with its lifetime tied to `&self`.
    #[must_use]
    pub fn view(&self) -> &ToolCallFailedView<'_> {
        self.0.reborrow()
    }
    ...
    /// [`::buffa::OwnedView`].
    #[must_use]
    pub fn to_owned_message(&self) -> super::super::ToolCallFailed {
...
for ToolCallFailedOwnedView {
    fn from(inner: ::buffa::OwnedView<ToolCallFailedView<'static>>) -> Self {
        ToolCallFailedOwnedView(inner)
    }
}
impl ::core::convert::From<ToolCallFailedOwnedView>
for ::buffa::OwnedView<ToolCallFailedView<'static>> {
    fn from(wrapper: ToolCallFailedOwnedView) -> Self {
        wrapper.0
    }
}
impl ::core::convert::AsRef<::buffa::OwnedView<ToolCallFailedView<'static>>>
for ToolCallFailedOwnedView {
    fn as_ref(&self) -> &::buffa::OwnedView<ToolCallFailedView<'static>> {
        &self.0
    }
}
impl ::buffa::HasMessageView for super::super::ToolCallFailed {
    type View<'a> = ToolCallFailedView<'a>;
    type ViewHandle = ToolCallFailedOwnedView;
}
impl ::serde::Serialize for ToolCallFailedOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
