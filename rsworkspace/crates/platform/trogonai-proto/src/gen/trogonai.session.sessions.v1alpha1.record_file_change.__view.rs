...
// source: trogonai/session/sessions/v1alpha1/record_file_change.proto
...
pub struct RecordFileChangeView<'a> {
    /// Field 1: `session_id`
...
impl<'a> ::buffa::MessageView<'a> for RecordFileChangeView<'a> {
    type Owned = super::super::RecordFileChange;
                ...
                match view.diff.as_mut() {
                    ...
                    None => {
                        view.diff = ::buffa::MessageFieldView::set(
                            <super::super::__buffa::view::DiffSummaryView as ::buffa::MessageView>::decode_view_ctx(
                                sub,
                                __sub_ctx,
                            )?,
                        );
    ...
    fn to_owned_message(
        &self,
    ) -> ::core::result::Result<super::super::RecordFileChange, ::buffa::DecodeError> {
    ...
    fn to_owned_from_source(
        ...
        let _ = __buffa_src;
        ::core::result::Result::Ok(super::super::RecordFileChange {
            ...
            diff: match self.diff.as_option() {
                Some(v) => {
                    ::buffa::MessageField::<
                        super::super::DiffSummary,
                        ::buffa::Inline<super::super::DiffSummary>,
                    >::some(v.to_owned_from_source(__buffa_src)?)
                }
                None => ::buffa::MessageField::none(),
            },
...
impl<'a> ::buffa::ViewEncode<'a> for RecordFileChangeView<'a> {
...
impl<'__a> ::serde::Serialize for RecordFileChangeView<'__a> {
...
impl<'a> ::buffa::MessageName for RecordFileChangeView<'a> {
    const PACKAGE: &'static str = "trogonai.session.sessions.v1alpha1";
    const NAME: &'static str = "RecordFileChange";
    const FULL_NAME: &'static str = "trogonai.session.sessions.v1alpha1.RecordFileChange";
    const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.RecordFileChange";
}
::buffa::impl_default_view_instance!(RecordFileChangeView);
::buffa::impl_view_reborrow!(RecordFileChangeView);
/** Self-contained, `'static` owned view of a `RecordFileChange` message.

 Wraps [`::buffa::OwnedView`]`<`[`RecordFileChangeView`]`<'static>>`: the decoded view and the [`::buffa::bytes::Bytes`] buffer it borrows from travel together, so the handle is `'static` and `Send + Sync` — suitable for async handlers, spawned tasks, and anywhere a `'static` bound is required.

 Field accessors return borrows tied to `&self`. Use [`Self::view`] to get the full [`RecordFileChangeView`] when you need struct patterns, iteration helpers, or to pass the view to lifetime-parameterised code.*/
#[derive(Clone, Debug)]
pub struct RecordFileChangeOwnedView(::buffa::OwnedView<RecordFileChangeView<'static>>);
impl RecordFileChangeOwnedView {
    ...
    pub fn decode(
        ...
        ::core::result::Result::Ok(
            RecordFileChangeOwnedView(::buffa::OwnedView::decode(bytes)?),
        )
    }
    ...
    pub fn from_owned(
        msg: &super::super::RecordFileChange,
    ) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        ::core::result::Result::Ok(
            RecordFileChangeOwnedView(::buffa::OwnedView::from_owned(msg)?),
        )
    }
    /// Borrow the full [`RecordFileChangeView`] with its lifetime tied to `&self`.
    #[must_use]
    pub fn view(&self) -> &RecordFileChangeView<'_> {
        self.0.reborrow()
    }
    ...
    /// [`::buffa::OwnedView`].
    #[must_use]
    pub fn to_owned_message(&self) -> super::super::RecordFileChange {
...
impl ::core::convert::From<::buffa::OwnedView<RecordFileChangeView<'static>>>
for RecordFileChangeOwnedView {
    fn from(inner: ::buffa::OwnedView<RecordFileChangeView<'static>>) -> Self {
        RecordFileChangeOwnedView(inner)
    }
}
impl ::core::convert::From<RecordFileChangeOwnedView>
for ::buffa::OwnedView<RecordFileChangeView<'static>> {
    fn from(wrapper: RecordFileChangeOwnedView) -> Self {
        wrapper.0
    }
}
impl ::core::convert::AsRef<::buffa::OwnedView<RecordFileChangeView<'static>>>
for RecordFileChangeOwnedView {
    fn as_ref(&self) -> &::buffa::OwnedView<RecordFileChangeView<'static>> {
        &self.0
    }
}
impl ::buffa::HasMessageView for super::super::RecordFileChange {
    type View<'a> = RecordFileChangeView<'a>;
    type ViewHandle = RecordFileChangeOwnedView;
}
impl ::serde::Serialize for RecordFileChangeOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
