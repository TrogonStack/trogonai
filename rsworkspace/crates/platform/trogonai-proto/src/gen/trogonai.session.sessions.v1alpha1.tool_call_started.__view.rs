...
// source: trogonai/session/sessions/v1alpha1/tool_call_started.proto
...
impl<'a> ::buffa::MessageView<'a> for ToolCallStartedView<'a> {
    ...
    fn to_owned_message(
        &self,
    ) -> ::core::result::Result<super::super::ToolCallStarted, ::buffa::DecodeError> {
...
impl<'__a> ::serde::Serialize for ToolCallStartedView<'__a> {
...
impl<'a> ::buffa::MessageName for ToolCallStartedView<'a> {
    ...
    const FULL_NAME: &'static str = "trogonai.session.sessions.v1alpha1.ToolCallStarted";
    const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.ToolCallStarted";
}
...
#[derive(Clone, Debug)]
pub struct ToolCallStartedOwnedView(::buffa::OwnedView<ToolCallStartedView<'static>>);
...
impl ::serde::Serialize for ToolCallStartedOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
