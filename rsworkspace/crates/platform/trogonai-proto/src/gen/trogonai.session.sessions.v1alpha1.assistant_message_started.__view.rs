...
// source: trogonai/session/sessions/v1alpha1/assistant_message_started.proto
...
pub struct AssistantMessageStartedView<'a> {
    /// Field 1: `session_id`
...
impl<'a> AssistantMessageStartedView<'a> {
...
impl<'a> ::buffa::MessageView<'a> for AssistantMessageStartedView<'a> {
    type Owned = super::super::AssistantMessageStarted;
    ...
    fn to_owned_message(
        ...
        super::super::AssistantMessageStarted,
        ::buffa::DecodeError,
    > {
    ...
    > {
        ...
        let _ = __buffa_src;
        ::core::result::Result::Ok(super::super::AssistantMessageStarted {
...
impl<'__a> ::serde::Serialize for AssistantMessageStartedView<'__a> {
...
impl<'a> ::buffa::MessageName for AssistantMessageStartedView<'a> {
    const PACKAGE: &'static str = "trogonai.session.sessions.v1alpha1";
    const NAME: &'static str = "AssistantMessageStarted";
    const FULL_NAME: &'static str = "trogonai.session.sessions.v1alpha1.AssistantMessageStarted";
    const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.AssistantMessageStarted";
}
::buffa::impl_default_view_instance!(AssistantMessageStartedView);
::buffa::impl_view_reborrow!(AssistantMessageStartedView);
/** Self-contained, `'static` owned view of a `AssistantMessageStarted` message.

 Wraps [`::buffa::OwnedView`]`<`[`AssistantMessageStartedView`]`<'static>>`: the decoded view and the [`::buffa::bytes::Bytes`] buffer it borrows from travel together, so the handle is `'static` and `Send + Sync` — suitable for async handlers, spawned tasks, and anywhere a `'static` bound is required.

 Field accessors return borrows tied to `&self`. Use [`Self::view`] to get the full [`AssistantMessageStartedView`] when you need struct patterns, iteration helpers, or to pass the view to lifetime-parameterised code.*/
#[derive(Clone, Debug)]
pub struct AssistantMessageStartedOwnedView(
    ::buffa::OwnedView<AssistantMessageStartedView<'static>>,
);
impl AssistantMessageStartedOwnedView {
    ...
    pub fn decode(
        ...
        ::core::result::Result::Ok(
            AssistantMessageStartedOwnedView(::buffa::OwnedView::decode(bytes)?),
        )
    }
    ...
    pub fn decode_with_options(
        ...
        ::core::result::Result::Ok(
            AssistantMessageStartedOwnedView(
    ...
    pub fn from_owned(
        msg: &super::super::AssistantMessageStarted,
    ) -> ::core::result::Result<Self, ::buffa::DecodeError> {
        ::core::result::Result::Ok(
            AssistantMessageStartedOwnedView(::buffa::OwnedView::from_owned(msg)?),
        )
    }
    /// Borrow the full [`AssistantMessageStartedView`] with its lifetime tied to `&self`.
    #[must_use]
    pub fn view(&self) -> &AssistantMessageStartedView<'_> {
        self.0.reborrow()
    }
    ...
    /// [`::buffa::OwnedView`].
    #[must_use]
    pub fn to_owned_message(&self) -> super::super::AssistantMessageStarted {
...
for AssistantMessageStartedOwnedView {
    fn from(inner: ::buffa::OwnedView<AssistantMessageStartedView<'static>>) -> Self {
        AssistantMessageStartedOwnedView(inner)
    }
}
impl ::core::convert::From<AssistantMessageStartedOwnedView>
for ::buffa::OwnedView<AssistantMessageStartedView<'static>> {
    fn from(wrapper: AssistantMessageStartedOwnedView) -> Self {
        wrapper.0
    }
}
impl ::core::convert::AsRef<::buffa::OwnedView<AssistantMessageStartedView<'static>>>
for AssistantMessageStartedOwnedView {
    fn as_ref(&self) -> &::buffa::OwnedView<AssistantMessageStartedView<'static>> {
        &self.0
    }
}
impl ::buffa::HasMessageView for super::super::AssistantMessageStarted {
    type View<'a> = AssistantMessageStartedView<'a>;
    type ViewHandle = AssistantMessageStartedOwnedView;
}
impl ::serde::Serialize for AssistantMessageStartedOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
