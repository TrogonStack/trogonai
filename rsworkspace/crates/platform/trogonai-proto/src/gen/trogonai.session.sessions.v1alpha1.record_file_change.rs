...
impl ::core::fmt::Debug for RecordFileChange {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("RecordFileChange")
...
impl RecordFileChange {
    ...
    pub const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.RecordFileChange";
}
impl RecordFileChange {
...
::buffa::impl_default_instance!(RecordFileChange);
impl ::buffa::MessageName for RecordFileChange {
...
impl ::buffa::Message for RecordFileChange {
...
impl ::buffa::json_helpers::ProtoElemJson for RecordFileChange {
...
#[doc(hidden)]
pub const __RECORD_FILE_CHANGE_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/trogonai.session.sessions.v1alpha1.RecordFileChange",
    to_json: ::buffa::type_registry::any_to_json::<RecordFileChange>,
    from_json: ::buffa::type_registry::any_from_json::<RecordFileChange>,
    is_wkt: false,
};
