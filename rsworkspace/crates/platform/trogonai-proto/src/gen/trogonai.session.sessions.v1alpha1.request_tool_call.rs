...
impl ::core::fmt::Debug for RequestToolCall {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("RequestToolCall")
...
impl RequestToolCall {
    ...
    pub const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.RequestToolCall";
}
impl RequestToolCall {
...
::buffa::impl_default_instance!(RequestToolCall);
impl ::buffa::MessageName for RequestToolCall {
...
impl ::buffa::Message for RequestToolCall {
...
impl ::buffa::json_helpers::ProtoElemJson for RequestToolCall {
...
#[doc(hidden)]
pub const __REQUEST_TOOL_CALL_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/trogonai.session.sessions.v1alpha1.RequestToolCall",
    to_json: ::buffa::type_registry::any_to_json::<RequestToolCall>,
    from_json: ::buffa::type_registry::any_from_json::<RequestToolCall>,
    is_wkt: false,
};
