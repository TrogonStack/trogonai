...
impl AssistantMessageCompleted {
    ...
    pub const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.AssistantMessageCompleted";
}
impl AssistantMessageCompleted {
...
pub const __ASSISTANT_MESSAGE_COMPLETED_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/trogonai.session.sessions.v1alpha1.AssistantMessageCompleted",
