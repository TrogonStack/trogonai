...
impl AssistantMessageFailed {
    ...
    pub const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.AssistantMessageFailed";
}
impl AssistantMessageFailed {
...
pub const __ASSISTANT_MESSAGE_FAILED_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/trogonai.session.sessions.v1alpha1.AssistantMessageFailed",
