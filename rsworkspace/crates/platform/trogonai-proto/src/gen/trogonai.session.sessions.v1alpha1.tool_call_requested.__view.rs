...
pub struct ToolCallRequestedView<'a> {
    /// Field 1: `session_id`
...
impl<'a> ToolCallRequestedView<'a> {
...
impl<'a> ::buffa::MessageView<'a> for ToolCallRequestedView<'a> {
    ...
    fn to_owned_from_source(
        ...
        let _ = __buffa_src;
        ::core::result::Result::Ok(super::super::ToolCallRequested {
...
impl<'a> ::buffa::ViewEncode<'a> for ToolCallRequestedView<'a> {
...
impl<'__a> ::serde::Serialize for ToolCallRequestedView<'__a> {
...
impl<'a> ::buffa::MessageName for ToolCallRequestedView<'a> {
...
::buffa::impl_default_view_instance!(ToolCallRequestedView);
::buffa::impl_view_reborrow!(ToolCallRequestedView);
/** Self-contained, `'static` owned view of a `ToolCallRequested` message.

 Wraps [`::buffa::OwnedView`]`<`[`ToolCallRequestedView`]`<'static>>`: the decoded view and the [`::buffa::bytes::Bytes`] buffer it borrows from travel together, so the handle is `'static` and `Send + Sync` — suitable for async handlers, spawned tasks, and anywhere a `'static` bound is required.

 Field accessors return borrows tied to `&self`. Use [`Self::view`] to get the full [`ToolCallRequestedView`] when you need struct patterns, iteration helpers, or to pass the view to lifetime-parameterised code.*/
#[derive(Clone, Debug)]
pub struct ToolCallRequestedOwnedView(
    ::buffa::OwnedView<ToolCallRequestedView<'static>>,
);
impl ToolCallRequestedOwnedView {
    ...
    pub fn decode(
        ...
        ::core::result::Result::Ok(
            ToolCallRequestedOwnedView(::buffa::OwnedView::decode(bytes)?),
        )
    }
    ...
    pub fn from_owned(
        ...
        ::core::result::Result::Ok(
            ToolCallRequestedOwnedView(::buffa::OwnedView::from_owned(msg)?),
        )
    }
    /// Borrow the full [`ToolCallRequestedView`] with its lifetime tied to `&self`.
    #[must_use]
    pub fn view(&self) -> &ToolCallRequestedView<'_> {
        self.0.reborrow()
    }
...
for ToolCallRequestedOwnedView {
    fn from(inner: ::buffa::OwnedView<ToolCallRequestedView<'static>>) -> Self {
        ToolCallRequestedOwnedView(inner)
    }
}
impl ::core::convert::From<ToolCallRequestedOwnedView>
for ::buffa::OwnedView<ToolCallRequestedView<'static>> {
    fn from(wrapper: ToolCallRequestedOwnedView) -> Self {
        wrapper.0
    }
}
impl ::core::convert::AsRef<::buffa::OwnedView<ToolCallRequestedView<'static>>>
for ToolCallRequestedOwnedView {
    fn as_ref(&self) -> &::buffa::OwnedView<ToolCallRequestedView<'static>> {
        &self.0
    }
}
impl ::buffa::HasMessageView for super::super::ToolCallRequested {
    type View<'a> = ToolCallRequestedView<'a>;
    type ViewHandle = ToolCallRequestedOwnedView;
}
impl ::serde::Serialize for ToolCallRequestedOwnedView {
    fn serialize<__S: ::serde::Serializer>(
        &self,
        __s: __S,
    ) -> ::core::result::Result<__S::Ok, __S::Error> {
