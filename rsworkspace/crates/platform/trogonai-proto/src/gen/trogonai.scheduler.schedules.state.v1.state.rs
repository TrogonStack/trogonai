...
pub struct State {
    ...
    pub schedule: ::buffa::MessageField<
        super::super::v1::Schedule,
        ::buffa::Inline<super::super::v1::Schedule>,
    >,
...
impl State {
    ...
    pub const TYPE_URL: &'static str = "type.googleapis.com/trogonai.scheduler.schedules.state.v1.State";
}
impl State {
...
pub const __STATE_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/trogonai.scheduler.schedules.state.v1.State",
