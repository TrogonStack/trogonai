...
impl ExecutionAttemptStarted {
    ...
    pub const TYPE_URL: &'static str = "type.googleapis.com/trogonai.session.sessions.v1alpha1.ExecutionAttemptStarted";
}
impl ExecutionAttemptStarted {
...
pub const __EXECUTION_ATTEMPT_STARTED_JSON_ANY: ::buffa::type_registry::JsonAnyEntry = ::buffa::type_registry::JsonAnyEntry {
    type_url: "type.googleapis.com/trogonai.session.sessions.v1alpha1.ExecutionAttemptStarted",
