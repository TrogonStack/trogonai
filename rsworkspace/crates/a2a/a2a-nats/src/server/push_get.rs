...
use crate::constants::PUSH_GET_METHOD as METHOD;
    ...
    N: trogon_nats::PublishClient,
{
    ...
    let result = match parse_request_params::<serde_json::Value>(METHOD, headers, payload) {
        ...
        Ok(raw) => match serde_json::from_value::<a2a::types::GetTaskPushNotificationConfigRequest>(raw) {
    ...
    publish_reply(nats, &reply, encoded, "push/get reply").await;
}
