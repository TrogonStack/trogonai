...
use trogon_semconv::span::A2A_SERVER_PUSH_SET;

use crate::constants::PUSH_SET_METHOD as METHOD;
...
#[instrument(name = A2A_SERVER_PUSH_SET, skip(handler, headers, payload, reply_subject, nats))]
