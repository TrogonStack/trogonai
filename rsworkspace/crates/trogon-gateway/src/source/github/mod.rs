...
//! |---|---|---|
//! | `GITHUB_WEBHOOK_SECRET` | **required** | HMAC-SHA256 secret configured in GitHub |
...
//! | `GITHUB_NATS_ACK_TIMEOUT_SECS` | `10` | NATS publish ack timeout in seconds |
//! | `GITHUB_MAX_BODY_SIZE` | `26214400` | Maximum webhook body size in bytes (default 25 MB) |
