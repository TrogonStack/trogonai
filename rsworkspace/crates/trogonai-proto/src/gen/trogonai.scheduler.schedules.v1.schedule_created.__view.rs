...
impl<'a> ::buffa::MessageView<'a> for ScheduleCreatedView<'a> {
    ...
    fn to_owned_message(&self) -> super::super::ScheduleCreated {
...
impl<'v> ::buffa::DefaultViewInstance for ScheduleCreatedView<'v> {
    fn default_view_instance<'a>() -> &'a Self
    where
        Self: 'a,
    {
        static VALUE: ::buffa::__private::OnceBox<ScheduleCreatedView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE
            .get_or_init(|| ::buffa::alloc::boxed::Box::new(
                <ScheduleCreatedView<'static>>::default(),
            ))
    }
}
impl ::buffa::ViewReborrow for ScheduleCreatedView<'static> {
    type Reborrowed<'b> = ScheduleCreatedView<'b>;
