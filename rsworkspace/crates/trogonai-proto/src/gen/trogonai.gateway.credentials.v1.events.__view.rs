...
impl<'a> ::buffa::MessageView<'a> for CredentialEventView<'a> {
    ...
    fn to_owned_message(&self) -> super::super::CredentialEvent {
...
impl<'v> ::buffa::DefaultViewInstance for CredentialEventView<'v> {
    fn default_view_instance<'a>() -> &'a Self
    where
        Self: 'a,
    {
        static VALUE: ::buffa::__private::OnceBox<CredentialEventView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE
            .get_or_init(|| ::buffa::alloc::boxed::Box::new(
                <CredentialEventView<'static>>::default(),
            ))
    }
}
impl ::buffa::ViewReborrow for CredentialEventView<'static> {
    type Reborrowed<'b> = CredentialEventView<'b>;
