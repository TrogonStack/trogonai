...
impl<'a> ::buffa::MessageView<'a> for ScheduleProjectionView<'a> {
    ...
    fn to_owned_message(&self) -> super::super::ScheduleProjection {
    ...
    ) -> super::super::ScheduleProjection {
...
impl<'v> ::buffa::DefaultViewInstance for ScheduleProjectionView<'v> {
    fn default_view_instance<'a>() -> &'a Self
    where
        Self: 'a,
    {
        static VALUE: ::buffa::__private::OnceBox<ScheduleProjectionView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE
            .get_or_init(|| ::buffa::alloc::boxed::Box::new(
                <ScheduleProjectionView<'static>>::default(),
            ))
    }
}
impl ::buffa::ViewReborrow for ScheduleProjectionView<'static> {
    type Reborrowed<'b> = ScheduleProjectionView<'b>;
