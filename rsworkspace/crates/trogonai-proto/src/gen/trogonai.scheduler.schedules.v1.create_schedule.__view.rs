...
impl<'a> ::buffa::MessageView<'a> for CreateScheduleView<'a> {
    ...
    fn to_owned_message(&self) -> super::super::CreateSchedule {
...
impl<'v> ::buffa::DefaultViewInstance for CreateScheduleView<'v> {
    fn default_view_instance<'a>() -> &'a Self
    where
        Self: 'a,
    {
        static VALUE: ::buffa::__private::OnceBox<CreateScheduleView<'static>> = ::buffa::__private::OnceBox::new();
        VALUE
            .get_or_init(|| ::buffa::alloc::boxed::Box::new(
                <CreateScheduleView<'static>>::default(),
            ))
    }
}
impl ::buffa::ViewReborrow for CreateScheduleView<'static> {
    type Reborrowed<'b> = CreateScheduleView<'b>;
