...
mod tests {
    ...
    fn test_bot_callback_and_inline_subjects() {
        ...
        assert_eq!(
            ...
            "telegram.prod.bot.inline.chosen"
        );
    }
    ...
    fn test_bot_chat_member_subjects() {
        assert_eq!(
            ...
            "telegram.prod.bot.chat.member_updated"
        );
        assert_eq!(
            bot::my_chat_member_updated("prod"),
            "telegram.prod.bot.chat.my_member_updated"
        );
    }
    ...
    fn test_bot_file_subjects() {
        ...
        assert_eq!(
            ...
            "telegram.prod.bot.file.downloaded"
        );
    }
    ...
    fn test_bot_payment_subjects() {
        assert_eq!(
            ...
            "telegram.prod.bot.payment.pre_checkout"
        );
        assert_eq!(
            bot::payment_shipping("prod"),
            "telegram.prod.bot.payment.shipping"
        );
        assert_eq!(
            bot::payment_successful("prod"),
            "telegram.prod.bot.payment.successful"
        );
    }
    ...
    fn test_bot_bot_commands_and_sticker_subjects() {
        assert_eq!(
            ...
            "telegram.prod.bot.bot_commands.response"
        );
        assert_eq!(
            bot::sticker_set_info("prod"),
            "telegram.prod.bot.sticker.set_info"
        );
        assert_eq!(
            bot::sticker_uploaded("prod"),
            "telegram.prod.bot.sticker.uploaded"
        );
    }
    ...
    fn test_agent_streaming_callback_inline_subjects() {
        assert_eq!(
            ...
            "telegram.prod.agent.message.send_photo"
        );
        assert_eq!(
            agent::message_stream("prod"),
            "telegram.prod.agent.message.stream"
        );
        assert_eq!(
        ...
        assert_eq!(
            ...
            "telegram.prod.agent.chat.action"
        );
        assert_eq!(
            agent::inline_answer("prod"),
            "telegram.prod.agent.inline.answer"
        );
    }
    ...
    fn test_agent_payment_subjects() {
        assert_eq!(
            ...
            "telegram.prod.agent.payment.send_invoice"
        );
        assert_eq!(
            agent::payment_answer_pre_checkout("prod"),
            "telegram.prod.agent.payment.answer_pre_checkout"
        );
        assert_eq!(
            agent::payment_answer_shipping("prod"),
            "telegram.prod.agent.payment.answer_shipping"
        );
    }
    ...
    fn test_agent_bot_commands_subjects() {
        assert_eq!(
            ...
            "telegram.prod.agent.bot_commands.set"
        );
        assert_eq!(
            agent::bot_commands_delete("prod"),
            "telegram.prod.agent.bot_commands.delete"
        );
        assert_eq!(
            agent::bot_commands_get("prod"),
            "telegram.prod.agent.bot_commands.get"
        );
    }
    ...
    fn test_agent_sticker_management_subjects() {
        assert_eq!(
            ...
            "telegram.prod.agent.sticker.upload_file"
        );
        assert_eq!(
            agent::sticker_add_to_set("prod"),
            "telegram.prod.agent.sticker.add_to_set"
        );
        assert_eq!(
            agent::sticker_set_position("prod"),
            "telegram.prod.agent.sticker.set_position"
        );
        assert_eq!(
            agent::sticker_delete_from_set("prod"),
            "telegram.prod.agent.sticker.delete_from_set"
        );
        assert_eq!(
            agent::sticker_set_title("prod"),
            "telegram.prod.agent.sticker.set_title"
        );
        assert_eq!(
            agent::sticker_set_thumbnail("prod"),
            "telegram.prod.agent.sticker.set_thumbnail"
        );
        assert_eq!(
            agent::sticker_delete_set("prod"),
            "telegram.prod.agent.sticker.delete_set"
        );
        assert_eq!(
            agent::sticker_set_emoji_list("prod"),
            "telegram.prod.agent.sticker.set_emoji_list"
        );
        assert_eq!(
            agent::sticker_set_keywords("prod"),
            "telegram.prod.agent.sticker.set_keywords"
        );
        assert_eq!(
            agent::sticker_set_mask_position("prod"),
            "telegram.prod.agent.sticker.set_mask_position"
        );
    }
    ...
    fn test_agent_forum_subjects() {
        assert_eq!(
            ...
            "telegram.prod.agent.forum.create"
        );
        assert_eq!(agent::forum_edit("prod"), "telegram.prod.agent.forum.edit");
        assert_eq!(
            agent::forum_close("prod"),
            "telegram.prod.agent.forum.close"
        );
        assert_eq!(
            agent::forum_reopen("prod"),
            "telegram.prod.agent.forum.reopen"
        );
        assert_eq!(
            agent::forum_delete("prod"),
            "telegram.prod.agent.forum.delete"
        );
        assert_eq!(
            agent::forum_unpin("prod"),
            "telegram.prod.agent.forum.unpin"
        );
        assert_eq!(
            agent::forum_edit_general("prod"),
            "telegram.prod.agent.forum.edit_general"
        );
        assert_eq!(
            agent::forum_close_general("prod"),
            "telegram.prod.agent.forum.close_general"
        );
        assert_eq!(
            agent::forum_reopen_general("prod"),
            "telegram.prod.agent.forum.reopen_general"
        );
        assert_eq!(
            agent::forum_hide_general("prod"),
            "telegram.prod.agent.forum.hide_general"
        );
        assert_eq!(
            agent::forum_unhide_general("prod"),
            "telegram.prod.agent.forum.unhide_general"
        );
        assert_eq!(
            agent::forum_unpin_general("prod"),
            "telegram.prod.agent.forum.unpin_general"
        );
    }
